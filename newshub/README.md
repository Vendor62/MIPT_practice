...
> **Внимание: это витринная (showcase) копия.**
> Реальный продовый и dev-репозиторий NewsHub приватен. Данный код
> выложен для демонстрации архитектуры комиссии МФТИ. В витрине
> намеренно могут быть проблемы с воспроизводимостью: часть секретов,
> миграционных данных и приватных интеграций отсутствует; некоторые
> пути и конфиги упрощены. Не рассматривайте эту папку как готовый
> к продакшен-запуску артефакт.
